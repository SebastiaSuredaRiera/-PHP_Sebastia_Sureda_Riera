...
<?php
if (isset ($genero)) echo "</br> el teu genere es: $genero</br>";
if (isset ($Termes)) echo "</br>estas $Termes amb els termes</br>";
if (isset ($PWD)) echo "</br> la teva contrasenya es: $PWD</br>";
if (isset ($Aniversari)) echo "</br> la teva fecha d'aniversari es: $Aniversari </br>";
if (isset ($Comentari)) echo "</br> els aspectes a millor del centre desde el teu puntd e vista son: $Comentari </br>";
if (isset ($Cicles)) echo "</br> has seleccionat $Cicles com el teu cicle formatiu </br>";
?>
